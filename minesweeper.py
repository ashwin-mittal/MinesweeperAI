...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for (x, y) in self.directions:
            ...
            if new_cell[0] >= self.height or new_cell[1] >= self.width or new_cell[0] < 0 or new_cell[1] < 0:
                continue
        ...
        for sentence0 in self.knowledge:
            for sentence1 in self.knowledge:
                if sentence0.cells >= sentence1.cells:
                    new_sentence = Sentence(
                        sentence0.cells - sentence1.cells, sentence0.count - sentence1.count)
                    if new_sentence not in self.knowledge:
                        new_knowledge.append(new_sentence)
                if sentence1.cells >= sentence0.cells:
                    new_sentence = Sentence(
                        sentence1.cells - sentence0.cells, sentence1.count - sentence0.count)
                    if new_sentence not in self.knowledge:
                        new_knowledge.append(new_sentence)
